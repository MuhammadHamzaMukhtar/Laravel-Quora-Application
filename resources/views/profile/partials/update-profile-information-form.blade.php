<section>
    ...
    <form method="post" action="{{ route('profile.update') }}" class="mt-6 space-y-6" enctype="multipart/form-data">
        ...
        <div>
            ...
            <span class="text-danger name-err mt-2"></span>
        </div>
        ...
        <div>
            ...
            <span class="text-danger email-err mt-2"></span>
...
<!--         
         <x-text-input id="image" name="pic" type="file" class="mt-1 block w-full" :value="old('pic', $user->profile_pic)" required autocomplete="pic" /> -->
            ...
            <img class="mt-1" src="{{asset('images/'.Auth::user()->profile_pic)}}" width="60px" height="60px" alt="" id="user-img" />
        </div>
